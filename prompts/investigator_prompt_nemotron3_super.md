...
```
canonical_id:         nvidia/nvidia-nemotron-3-super-120b-a12b-bf16
display_name:         NVIDIA Nemotron 3 Super 120B (A12B, BF16)
provider:             nvidia
release_date:         <VERIFY: ISO date from HF card>
authoritative_paper:  <VERIFY: NVIDIA Nemotron 3 tech report URL if available>
authoritative_repo:   https://github.com/NVIDIA/NeMo
authoritative_card:   https://huggingface.co/nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-BF16
