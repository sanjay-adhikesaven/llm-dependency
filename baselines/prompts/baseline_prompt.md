...
```
canonical_id:         <SUBJECT_CANONICAL_ID>            # e.g., allenai/olmo-3-1125-32b
display_name:         <SUBJECT_DISPLAY_NAME>            # e.g., Olmo 3 32B (base)
provider:             <SUBJECT_PROVIDER>                # e.g., allenai
release_date:         <SUBJECT_RELEASE>                 # ISO date
authoritative_paper:  <SUBJECT_PAPER_URL_OR_NONE>
authoritative_repo:   <SUBJECT_REPO_URL_OR_NONE>
authoritative_card:   <SUBJECT_HF_CARD_URL_OR_NONE>
scope_note:           <SUBJECT_SCOPE_NOTE_OR_NONE>      # see below
max_depth:            <MAX_DEPTH>                       # integer ≥ 1, or "unbounded"
```
