...
def migrate(conn: sqlite3.Connection) -> None:
    ...
    _ensure_column(conn, "mentions", "links_json", "links_json TEXT NOT NULL DEFAULT '[]'")
    _ensure_column(conn, "mentions", "anchors_json", "anchors_json TEXT NOT NULL DEFAULT '[]'")
    ...
    _ensure_column(conn, "lattice_nodes", "links_json", "links_json TEXT NOT NULL DEFAULT '[]'")
    _ensure_column(conn, "lattice_nodes", "verified_links_json", "verified_links_json TEXT NOT NULL DEFAULT '[]'")
